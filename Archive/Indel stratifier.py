#Fleshes out the indels in a VCF file as sequential point mutations.
#Input is a dataframe with Chromosome+Position, reference allele, alternate allele and genotype (./.). 
